...
class SPAM:
    ...
    def banner(self):
        ...
        title = '\n\n\n---By công Trình đẹp zai nhất hệ mặt trời ---'
        banner = '''\n 
   ...
   \ \_\   \ \____/  \ \_\
    ...
    def send_otp(self):
        ...
        try:
            ...
            if 'Thành công' in response:
                print(self.format_print("PCT",f"MOMO: {response}"))
            else:
                print(self.format_print("PCT",f"MOMO: "+response))
        except:
            print(self.format_print("PCT",f"MOMO: BAD REQUESTS LIMIT!"))
    def send_code(self):
        json_data = {
                'user': self.phone,
    ...
    def Gbay(self):
        ...
        try:
            ...
            print(self.format_print("PCT",f"GBAY: SUCCESS!"))
        except:
            print(self.format_print("PCT",f"GBAY: ERROR!"))
    ...
    def moca(self):
        ...
        try:
            ...
            print(self.format_print("PCT",f"MOCA: SUCCESS!"))
        except:
            print(self.format_print("PCT",f"MOCA: ERROR!"))
    ...
    def zalopay(self):
        try:
            ...
            print(self.format_print("PCT",f"ZALOPAY: SUCCESS!"))
        except:
            print(self.format_print("PCT",f"ZALOPAY: ERROR!"))
    def tiki(self):
        try:
            json_data = {
                    'phone_number': self.phone,
            ...
            print(self.format_print("PCT",f"TIKI: SUCCESS!"))
        except:
            print(self.format_print("PCT",f"TIKI: ERROR!"))
    def meta_vn(self):
        try:
            params = {
                'api_mode': '1',
            ...
            print(self.format_print("PCT",f"METAVN: SUCCESS!"))
        except:
            print(self.format_print("PCT",f"METAVN: ERROR!"))
    def vntrip(self):
        try:
            json_data = {
                'feature': 'register',
            ...
            print(self.format_print("PCT",f"VNTRIP: SUCCESS!"))
        except:
            print(self.format_print("PCT",f"VNTRIP: ERROR!"))
    ...
    def run(self):
        while True:
            self.banner()
            self.phone = input(self.format_input("PCT",f"NHẬP SDT ĐỂ CR7 SPAM CHO: "))
            if self.phone != '0937576173':
                if len(self.phone) == 10:
                    break
                print(self.format_print("PCT", "SỐ ĐIỆN THOẠI DƯỚI <10 SỐ XIN NHẬP LẠI !"))
            if self.phone == '0937576173':
                print(self.format_print("PCT", "LÀM ƠN ĐỪNG SPAM SỐ ĐIỆN THOẠI PCT!"))
            time.sleep(3)
...
if __name__ == "__main__":
    try:
        ...
        time.sleep(3)
        sys.exit('\n'+SPAM().format_print('√', 'Ronaldo Siuuu'))
